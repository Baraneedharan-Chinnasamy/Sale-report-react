...
/>
  ...
  style={{backgroundColor: '#ef4444',padding: '4px 6px',height: '28px',
width: '28px',
    minWidth: 'unset',
    borderRadius: '6px',
    fontSize: '14px',
